...
CREATE TABLE tbl_date(
	...
	ccol timestamp(9) ,		--9는 초 단위 소수점이하 9자리까지 표시
...
SELECT * FROM tbl_date; 자바꺼보자 아깐또왜된거?

INSERT INTO tbl_date(acol,ccol)
VALUES ('2022-10-11','2022-10-12');	--DATE, timestamp 차이 없습니다.
 -- 내일 시험에 나오는뎅 timestamp를 date라 생각하고 풀것 
-- 날짜형식은 문자열 'yyyy-MM-dd' 과 자동캐스팅이 됩니다.
-- date와 timestamp 모두 to_char 함수는 동일하게 사용합니다.


--GMT , UTC 표준시간의 차이 참고로 알아보면 좋음
